...
datafilename = 'sift1m-percentage-varying-cluster'
yaxis_legend = 'Checked vectors (%)'
...
with open(datafilepath + datafilename + '.csv') as f:
    ...
    legend = plt.legend(bbox_to_anchor=(0.3,1), loc='upper center', ncol=1, frameon=False)
    # plt.legend()
